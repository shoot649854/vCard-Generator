...
def create_apple_contact_file(name_details, work_details, email_details, address_details, phone, image_path=None, gender=None, birthday=None, note=None):
    ft = format()
    # Build vCard string
    vcard = f"BEGIN:VCARD\nVERSION:3.0\n"
    ...
    # Write vCard to file
    full_name = name_details.get('first_name', '') + ' ' + name_details.get('last_name', '')
...
def main():
    parser = argparse.ArgumentParser(description='Create an Apple contact file (vCard).')
